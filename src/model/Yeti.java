...
public class Yeti extends MoveablePiece {
	...
	/**
	 * <b><p>Constructor</p></b>
	 * <p>Postconditions: creates a new Yeti and sets via set methods rank = 5,  
	 * 'team' team,  numOfRescues = 0</p>
	 * @param team is the team that Yeti belongs
	 */
	public Yeti() {
		setRank(5);
		setTeam(Team.BLUE);
	...
	/**
	 * <b><p>Transformer</p></b>
	 * <p>Postconditions: the Yeti attacks a Piece</p>
	 ...
	 * <p>Postconditions: return the number of the rescues this Yeti has done</p>
	 * @return the number of the rescues this Yeti has done
	 */
	 ...
	 * <p>Postconditions: sets the number of rescues this Yeti has done to numOfRescues
	 * @param numOfRescues is the new number of rescues this Yeti has done</p>
	 */
