...
public class Slayer extends MoveablePiece {

	private int numOfRescues;
	
	/**
	 * <b><p>Constructor</p></b>
	 * <p>Postconditions: creates a new Slayer and sets via set methods rank = 1,  
	 * 'team' team, numOfRescues = 0</p>
	 * @param team is the team that Slayer belongs
	 */
	public Slayer(Team team) {
		setRank(1);
		setTeam(team);
		setNumOfRescues(0);
	}
	...
	/**
	 * <b><p>Transformer</p></b>
	 * <p>Postconditions: the Slayer attacks a Piece</p>
	...
	public int attack(Position position1, Position position2, Board board, Player player1, Player player2) {
		if ((board.getBoardElement(position2).getRank() == 10) || (board.getBoardElement(position2).getRank() == -1)) {
		...
		else if (board.getBoardElement(position2).getRank() == 1) {
			player1.lostPieces.add(board.getBoardElement(position1));
			board.setBoardElement(null, position1);
			player2.lostPieces.add(board.getBoardElement(position2));
	 ...
	 * <p>Postconditions: return the number of the rescues this Slayer has done</p>
	 * @return the number of the rescues this Slayer has done
	 */
	 ...
	 * <p>Postconditions: sets the number of rescues this Slayer has done to numOfRescues</p>
	 * @param numOfRescues is the new number of rescues this Slayer has done
	 */
